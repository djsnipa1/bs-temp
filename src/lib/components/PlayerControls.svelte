...
<div
  ...
  {#if !$isVideoPlaying}
  <button class="buttonClass group col-span-3 col-start-3 row-start-2 !h-14 !w-14" on:click={() => { isVideoPlaying.set(true) }}
    >
  ...
  {#if $isVideoPlaying}
  <button class="buttonClass group col-span-3 col-start-3 row-start-2 !h-14 !w-14" on:click={() => { isVideoPaused.set(true) }}>
  <span class="spanClass !h-12 !w-12">PAUSE</span>
 <svg xmlns="http://www.w3.org/2000/svg" class="svgClass" viewBox="0 0 24 24"><g fill="none"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M9 3a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm8 0a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z"/></g></svg>
...
<style>
  ...
  */
  ...
  .spanClass {
    @apply absolute z-10 w-full transform-gpu text-center font-sofiasans font-normal text-base text-slate-100 group-hover:scale-[80%] group-hover:transition-all transition-all group-hover:duration-300 duration-300 hidden;
  }
