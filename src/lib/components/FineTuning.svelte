...
>
	<div class="h-8">
		<NeuromorphicText textColor={'mix-blend-difference'}>28</NeuromorphicText>
	</div>
	<div class="h-8">
		<NeuromorphicText textColor={'mix-blend-difference'}>11</NeuromorphicText>
	</div>
	<div class="mx-auto mt-0 flex w-1/2 justify-center">
		<BlankButton>
	...
	<div class="mx-auto flex w-1/2 justify-center">
		<BlankButton>
			<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-slate-400 mix-blend-difference" viewBox="0 0 24 24">
				<path
					fill="currentColor"
	...
	<div><p class="mix-blend-difference">Nudge Left</p></div>
	<div><p class="mix-blend-difference">Nudge Right</p></div>
</div>

<style>
	* {
		@apply box-border border-yellow-500 font-sofiasans;
	}
